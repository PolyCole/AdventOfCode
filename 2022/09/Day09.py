...
class Grid:
    ...
    def move_tail(self):
        # offset = (self.tail_i != self.head_i and self.tail_j != self.head_j)
        far_laterally = abs(self.tail_i - self.head_i) >= 2
        far_horizontally = abs(self.tail_j - self.head_j) >= 2

        # print(f"{offset}, {far_laterally}, {far_horizontally}")
        # print(f"{self.last_movement}")
        # print(f"{transformation[self.last_movement](self.head_i, self.head_j)}")
